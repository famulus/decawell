...
torus_negative = 0.85 * torus
connector_thickness = torus * 0.7
joint_nudge = 0.90 # this is a percentage scaling of the vector defining the ideal joint location
...
:joint_radius => connector_thickness,
}
